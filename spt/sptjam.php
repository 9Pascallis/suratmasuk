...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contact">Surat Masuk</a></li>
          <li><a class="nav-link scrollto" href="#contact">Surat Keluar</a></li>
          <li class="dropdown"><a href="#"><span>SPT</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">SPT Jam</a></li>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <h3 class="" style="text-align:center"><b> INPUT SPT UNTUK KEGIATAN JAM</b></h3>
        <br><br>
        <p>
