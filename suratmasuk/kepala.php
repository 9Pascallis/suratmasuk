...
<link rel="stylesheet" type="text/css" href="suratmasuk/public/css/operator.css">
            ...
            <table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        ...
                        <th width="50px">Tanggal Agenda</th>
                        <th width="10px">Tingkat Keamanan</th>
                        <th width="50px">Tanggal Surat</th>
                        <th width="20px">No Surat</th>
                        <th width="50px">Asal Surat</th>
